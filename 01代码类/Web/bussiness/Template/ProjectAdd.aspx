...
<form action="/bussiness/template/projectadd.aspx" method="post">
    <div class="alert alert-info">当前位置<b class="tip"></b>维护界面<b class="tip"></b>案卷登记</div>

    <table class="table table-striped table-bordered table-condensed list">
        <thead>
            <tr>
                <td colspan="4"><b>案卷基本信息</b></td>
            </tr>
        </thead>
        <tbody>
           
            <tr>
                <td width="15%">上报人<font color="FF0000">*</font></td>
                <td width="500">
                    <input name="txt_name" value="<%=user.Username %>" type="text"  readonly="readonly"/>
                </td>
                <td width="500">坐标<font color="FF0000">*</font></td>
                <td width="500">
                    <input name="txt_location" value="" type="text" /></td>
            </tr>
            <tr>
                <td>所属区域<font color="FF0000">*</font></td>
                <td>
                ...
                <td>所属街道<font color="FF0000">*</font></td>
                <td>
                     <select name="txt_street">
                      <%foreach (var v in Streettlist())
                       { %>
                        <option value="<%=v.Streetcode %>"><%=v.Streetname %> </option>
                         <%} %>
                    </select></td>
            </tr>
            <tr>
                <td>所属社区<font color="FF0000">*</font></td>
                <td>
                   <select name="txt_commnuity">
                        <%foreach (var v in Communitylist())
                       { if(!string.IsNullOrEmpty(v.Commname)){%>
                        <option value="<%=v.Commcode %>"><%=v.Commname %> </option>
                         <%} }%>
                    </select>
                </td>
                <td>大类<font color="FF0000">*</font></td>
                <td>
            ...
            <tr>
                <td>案卷类型<font color="FF0000">*</font></td>
                <td>
                    <select name="txt_projecttype">
                      <option value="1">一般 </option>
                         <option value="2">紧急 </option>
                    </select></td>
                <td>小类<font color="FF0000">*</font></td>
                <td>
        ...
        <tfoot>
            <tr>
                <td colspan="4">
                    ...
                    <input class="btn btn-inverse" type="button" value="取消" onclick="window.history.go(-1)"/></td>
            </tr>
        </tfoot>
    </table>
    </form>
