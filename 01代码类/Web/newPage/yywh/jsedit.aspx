<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jsedit.aspx.cs" Inherits="TX_Bussiness.Web.newPage.yywh.jsedit" %>
                ...
                <div class="content">
                    <div class="box">
                        <div class="box_tit">
                            角色管理</div>
                        <div class="box_con">
                            <form action="/newPage/yywh/jsedit.aspx" method="post" class="valifrom" id="form1">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="500" colspan="3">
                                            <input name="txt_rolename" value="<%=model.Rolename %>" type="text" datatype="*"
                                                nullmsg="请填写角色名称！" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            所有权限<font color="FF0000">*</font>
                                            <input type="hidden" name="limitids" value="" />
                                        </td>
                                        <td colspan="3">
                                            <label class="c_role">
                                                <input type="checkbox" name="limitid" value="<%=TX_Bussiness.Web.Comm.Constant.RYDW %>"
                                                    <%=HasLimit(TX_Bussiness.Web.Comm.Constant.RYDW,model.Limitid)?"checked='checked'":"" %> />人员定位系统</label>
                                            <label class="c_role">
                                                <input type="checkbox" name="limitid" value="<%=TX_Bussiness.Web.Comm.Constant.QWSS %>"
                                                    <%=HasLimit(TX_Bussiness.Web.Comm.Constant.QWSS,model.Limitid)?"checked='checked'":"" %> />勤务实时系统</label>
                                            <label class="c_role">
                                                <input type="checkbox" name="limitid" value="<%=TX_Bussiness.Web.Comm.Constant.SBJB %>"
                                                    <%=HasLimit(TX_Bussiness.Web.Comm.Constant.SBJB,model.Limitid)?"checked='checked'":"" %> />上报交办系统</label>
                                            <label class="c_role">
                                                <input type="checkbox" name="limitid" value="<%=TX_Bussiness.Web.Comm.Constant.QWSJ %>"
                                                    <%=HasLimit(TX_Bussiness.Web.Comm.Constant.QWSJ,model.Limitid)?"checked='checked'":"" %> />勤务数据系统</label>
                                            <label class="c_role">
                                                <input type="checkbox" name="limitid" value="<%=TX_Bussiness.Web.Comm.Constant.YYWH%>"
                                                    <%=HasLimit(TX_Bussiness.Web.Comm.Constant.YYWH,model.Limitid)?"checked='checked'":"" %> />应用维护系统</label>
                                        </td>
                                    </tr>
                                </tbody>
                                <tfoot>
