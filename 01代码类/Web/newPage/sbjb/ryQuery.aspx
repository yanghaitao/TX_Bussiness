<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ryQuery.aspx.cs" Inherits="TX_Bussiness.Web.newPage.sbjb.ryQuery" %>
                ...
                <div class="main-wrap">
                    ...
                    <div class="search_con noborder">
                        <div class="search_data">
                            <form action="/newpage/sbjb/ryQuery.aspx" method="get">
                            <div class="ip_list">
                                &nbsp;处理部门：<select size="1" name="txt_depart" id="bumen" disabled="disabled" class="ipw130">
                                    <option value="0">全部</option>
                                    <option value="<%=user.Departcode%>" selected="selected">
                                        <%=dname%></option>
                                </select>&nbsp;&nbsp; 人员：
                                <select size="1" name="txt_user" id="Select1" class="ipw130">
                                    <option value="0">全部</option>
                                    <%foreach (var v in GetUserList(user.Departcode.ToString()))
                                      {
                                          if (!string.IsNullOrEmpty(v.Username))
                                          { %>
                                    <option value="<%=v.Id %>" <%=txt_user==v.Username.ToString()?"selected=selected":"" %>>
                                        <%=v.Username%></option>
                                    <%}
                                      }%>
                                </select>
