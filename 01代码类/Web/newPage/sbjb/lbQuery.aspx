<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lbQuery.aspx.cs" Inherits="TX_Bussiness.Web.newPage.sbjb.lbQuery" %>
...
<body>
    <div class="container">
        ...
        <!--header end-->
        <div class="tip">
            当前位置：<a href="#">上报交办系统</a> > <a href="ryQuery.aspx">任务查询</a> > 类别查询</div>
        <!--content start-->
