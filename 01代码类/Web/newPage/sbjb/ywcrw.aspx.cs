...
{
    public partial class ywcrw : Comm.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string pageUrl = "/newPage/sbjb/ywcrw.aspx?txt_projectcode={0}&txt_projectstate={1}&txt_depart={2}&txt_area={3}&txt_street={4}&txt_commnuity={5}&txt_startdate={6}&txt_enddate={7}&page=__id__";
