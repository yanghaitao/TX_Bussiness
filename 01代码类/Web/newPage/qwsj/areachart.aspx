<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="areachart.aspx.cs" Inherits="TX_Bussiness.Web.newPage.qwsj.areachart" %>
    ...
    <div class="main layout">
            ...
            <div class="main-wrap">
                ...
                <div class="content">
                    <div class="search_data">
                        <form action="/newpage/qwsj/areachart.aspx" method="get" class="valifrom">
        ...
        <div class="col-sub">
            ...
            <div class="menu">
                ...
                <div class="menu_con">
                    <ul>
                        <li class="cur"><a href="/newpage/qwsj/areachart.aspx">区域统计</a></li>
