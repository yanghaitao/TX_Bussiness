<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="depart_info.aspx.cs" Inherits="TX_Bussiness.Web.newPage.qwsj.depart_info" %>
...
<body>
    ...
    <div class="header" style="position: relative;">
        ...
        <div class="nav">
            <ul class="left">
                <li><a href="/newpage/qwsj/index.aspx">首页</a></li><li class="cur"><a href="/newpage/qwsj/area_info.aspx">
            ...
            <div class="main-wrap">
                ...
                <div class="content">
                    <div class="search_data">
                        <form action="/newpage/qwsj/depart_info.aspx" method="get" class="valifrom">
                        <div class="ip_list">
            ...
            <div class="menu">
                ...
                <div class="menu_con">
                    <ul>
                        ...
                        <li class="cur"><a href="/newpage/qwsj/depart_info.aspx">部门统计</a></li>
                    </ul>
                </div>
            </div>
            <!--menu end -->
