<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="departchart.aspx.cs" Inherits="TX_Bussiness.Web.newPage.qwsj.departchart" %>
            ...
            <div class="main-wrap">
                ...
                <div class="content">
                    <div class="search_data">
                        <form action="/newpage/qwsj/departchart.aspx" method="get" class="valifrom">
            ...
            <div class="menu">
                ...
                <div class="menu_con">
                    <ul>
                        ...
                        <li><a href="/newpage/qwsj/collectorchart.aspx">人员统计</a></li>
                        <li class="cur"><a href="/newpage/qwsj/departchart.aspx">部门统计</a></li>
                    </ul>
                </div>
            </div>
            <!--menu end -->
