...
{
	/// <summary>
	/// Strongly-typed collection for the DepartInfo class.
	/// </summary>
    [Serializable]
	public partial class DepartInfoCollection : ActiveList<DepartInfo, DepartInfoCollection>
	{	   
		public DepartInfoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>DepartInfoCollection</returns>
		public DepartInfoCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the depart_info table.
	/// </summary>
	[Serializable]
	public partial class DepartInfo : ActiveRecord<DepartInfo>, IActiveRecord
	{
		...
		public DepartInfo(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public DepartInfo(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public DepartInfo(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("depart_info", TableType.Table, DataService.GetInstance("Yannis_DAO"));
				...
				DataService.Providers["Yannis_DAO"].AddSchema("depart_info",schema);
			}
		}
		#endregion
