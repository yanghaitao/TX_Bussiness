...
{
	/// <summary>
	/// Strongly-typed collection for the AreaInfo class.
	/// </summary>
    [Serializable]
	public partial class AreaInfoCollection : ActiveList<AreaInfo, AreaInfoCollection>
	{	   
		public AreaInfoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AreaInfoCollection</returns>
		public AreaInfoCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the area_info table.
	/// </summary>
	[Serializable]
	public partial class AreaInfo : ActiveRecord<AreaInfo>, IActiveRecord
	{
		...
		public AreaInfo(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AreaInfo(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("area_info", TableType.Table, DataService.GetInstance("Yannis_DAO"));
				...
				DataService.Providers["Yannis_DAO"].AddSchema("area_info",schema);
			}
		}
		#endregion
