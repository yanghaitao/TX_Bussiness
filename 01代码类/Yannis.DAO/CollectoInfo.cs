...
{
	/// <summary>
	/// Strongly-typed collection for the CollectoInfo class.
	/// </summary>
    [Serializable]
	public partial class CollectoInfoCollection : ActiveList<CollectoInfo, CollectoInfoCollection>
	{	   
		public CollectoInfoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>CollectoInfoCollection</returns>
		public CollectoInfoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                CollectoInfo o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the collecto_info table.
	/// </summary>
	[Serializable]
	public partial class CollectoInfo : ActiveRecord<CollectoInfo>, IActiveRecord
	{
		...
		public CollectoInfo(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public CollectoInfo(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public CollectoInfo(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("collecto_info", TableType.Table, DataService.GetInstance("Yannis_DAO"));
				...
				DataService.Providers["Yannis_DAO"].AddSchema("collecto_info",schema);
			}
		}
		#endregion
