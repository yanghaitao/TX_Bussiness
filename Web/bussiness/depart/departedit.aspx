...
<body>
    <form action="/bussiness/depart/departedit.aspx" method="post">
    ...
    <table class="table table-striped table-bordered table-condensed list">
        ...
        <tbody>
            <tr>
                ...
                <td width="500">
                    <input name="txt_departname" value="<%=model.Departname %>" type="text" />
                </td>
                <td width="500">
            ...
            <tr>
                ...
                <td>
                    <input name="txt_departmobile" value="<%=model.Departmobile %>" type="text" />
                </td>
                <td>
                    部门电话<font color="FF0000">*</font>
                </td>
                <td>
                    <input name="txt_departtel" value="<%=model.Departtel %>" type="text" />
                </td>
            </tr>
            <tr>
                <td>
